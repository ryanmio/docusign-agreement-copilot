...
export function BulkOperationViewPreview({ operationId = 'bulk-123' }: BulkOperationViewPreviewProps) {
  ...
  // Sort recipients to show errors first
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full max-w-6xl mx-auto mt-4 text-[#4C00FF] hover:text-[#4C00FF] hover:bg-[#4C00FF]/10 py-2 px-4 rounded flex items-center justify-center font-medium transition-colors duration-200"
      >
        Restart Demo
      </button>
    </div>
