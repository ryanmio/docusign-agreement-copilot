        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.docusign.net https://*.docusign.com https://*.supabase.co wss://*.supabase.co https://unpkg.com https://ahynitsoacoisrgodqqq.supabase.co https://*.w3.org https://www.w3.org",
